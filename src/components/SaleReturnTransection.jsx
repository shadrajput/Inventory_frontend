    ...
    return (
        <>
            <div className=" h-[440px] bg-white shadow-lg">
                {/* Search Transection */}
                <div className="flex mt-3 w-full items-center justify-between p-3">
                    ...
                    <NavLink to="/Sales/SalesReturn/AddCreditNote">
...
export default SalesReturnTransection;
