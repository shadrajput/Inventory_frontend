            ...
            <div className="inline-block w-full bg-[#92929227] text-left transition-all transform bg-gray-700 shadow-xl rounded-lg ">
                ...
                <div className="">
                    <form action="">
                        ...
                        <div className="flex justify-between items-start px-5 py-10 ">
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center space-x-2">
                                    ...
                                    <input type="text" className="focus:outline-none border-b px-3 bg-transparent" />
                                </div>
                                <div className="flex items-center justify-between space-x-2">
                                    <label htmlFor="Invoice Date" className="text-slate-400 text-sm">Invoice Date</label>
                                    <input type="Date" name="" id="" className="text-sm bg-transparent" />
                                </div>
                            </div>
                        </div>
                        {/* Name and Number Details */}
                        ...
                        <div className="px-5">
                            <div className="flex items-start justify-between  py-8">
                                <div className="flex flex-col space-y-8">
                                    <select name="paymenttype" id="" className="text-sm w-40 border-2 border-slate-400 rounded-md h-10 bg-transparent focus:outline-none text-black px-2">
                                    ...
                                    <input type="text" name="" id="" placeholder="Referance No." className="bg-transparent focus:outline-none w-40 border-2 border-slate-400 rounded-md px-2 h-10" />
                                    <div className="flex text-blue-500 items-center text-sm ml-2">
                        ...
                        {/* Save & Print Buttons */}
                        <div className=" flex bg-white items-center justify-end space-x-5 py-5 pr-5 ">
...
export default PurchasenvoiceForm;