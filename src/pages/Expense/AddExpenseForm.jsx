    ...
    return (
        <div
            ...
            <div className="inline-block w-full bg-[#92929227] text-left transition-all transform bg-gray-700 shadow-xl rounded-lg ">
                <div className="border-b py-5 px-10 bg-white border-slate-200 flex items-center">
                    <h1
                        as="h3"
                    ...
                    <div className="pl-10 flex items-center space-x-3">
                        <h1 className="text-black font-medium">GST</h1>
                        <SwitcherOne/>
                    </div>
                ...
                <div className="">
                    <form action="">
                        ...
                        <div className="flex justify-between items-start px-5 py-10 ">
                            ...
                            <div className="space-y-3 w-1/3">
                                <div className="flex items-center space-x-2 w-full">
                                    <label htmlFor="Invoice Number" className="text-slate-400 text-sm text-end w-full">Return No</label>
                                    <input type="text" className="focus:outline-none border-b px-3 bg-transparent w-full" />
                                </div>
                                <div className="flex items-center space-x-2 w-full">
                                    <label htmlFor="Invoice Number" className="text-slate-400 text-sm text-end w-full">Invoice Number</label>
                                    <input type="text" className="focus:outline-none border-b px-3 bg-transparent w-full" />
                                </div>
                                ...
                                <div className="flex items-center justify-between space-x-2 w-full">
                                    <label htmlFor="Invoice Date" className="text-slate-400 text-sm text-end w-full">Date</label>
                                    <input type="Date" name="" id="" className="text-sm bg-transparent w-full" />
                                </div>
                                <div className="flex items-center justify-between space-x-2 w-full">
                        ...
                        <div className="flex items-center justify-between py-10 px-5">
                            <div>
                                <select name="paymenttype" id="" className="text-sm w-40 h-10 border-2 rounded-md border-slate-500 bg-transparent focus:outline-none text-black px-2">
                                    <option value="Payment Type">Payment Type</option>
                                    <option value="Cash">Cash</option>
                                    <option value="Credit Card">Credit Card</option>
                                    <option value="Debit Card">Debit Card</option>
                                </select>
                                <div className="flex text-blue-500 items-center text-sm ml-2 py-3">
                            ...
                            <div className="">
                                ...
                                <div className="flex items-center justify-end space-x-3 mt-2">
                                    <input type="checkbox" name="" id="" className="w-4 h-4" />
                                    <h1 className="text-sm">Advance Amount</h1>
                                    <input type="text" name="" id="" className="rounded-md border-2 h-10" />
                                </div>
                                <div className="flex items-center justify-between pt-5">
                                    <h1 className="text-end text-black font-medium w-full">Balance</h1>
                                    <h1 className="w-full text-end text-black font-medium">599</h1>
                                </div>
                            </div>
                        </div>
                        {/* Payment Type  */}
                        ...
                        {/* Save & Print Buttons */}
                        <div className=" flex bg-white items-center justify-end space-x-5 py-5 mr-5 ">
